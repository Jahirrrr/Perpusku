...
const BookPage = () => {
  ...
  const [book, setBook] = useState({
    id: "", name: "", isbn: "", summary: "", isAvailable: true, brokenBook: "", goodBook: "", publishYear: "", authorId: "", genreId: "", photoUrl: ""
  })
  ...
  const clearForm = () => {
    setBook({id: "", name: "", isbn: "", summary: "", isAvailable: true, brokenBook: "", goodBook: "", publishYear: "", authorId: "", genreId: "", photoUrl: ""})
  }
              ...
              <Grid key={book._id} item xs={12} sm={6} md={4}>
                <Card>
                  <Box sx={{pt: '80%', position: 'relative'}}>
                    ...
                    <StyledBookImage alt={book.name} src={"https://i.ibb.co/g9fP9vQ/download-4.jpg"}/>
                  </Box>
